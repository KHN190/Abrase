...
#[test]
#[ignore = "parser: variant syntax `type X = | A | B` not implemented"]
...
#[test]
#[ignore = "parser: variant syntax `type X = | A(T)` not implemented"]
...
#[test]
#[ignore = "parser: variant syntax `type X = | A { f: T }` not implemented"]
...
#[test]
#[ignore = "parser: `pub` modifier on record field not recognized"]
...
// <ownership-attr> — @copy
#[test]
#[ignore = "parser: ownership attrs (@copy/@move/@share) not parsed"]
...
// <handle-arm>  exn arm
#[test]
#[ignore = "parser: `exn` keyword as handle-arm kind not parsed (only effect names + return)"]
fn handle_arm_exn() {
...
#[test]
#[ignore = "parser: `..` rest token in array pattern not parsed"]
...
#[test]
#[ignore = "parser: record patterns like `Pt { x, y }` produce Variant instead of Record"]
...
#[test]
#[ignore = "parser: record pattern `Pt { x: px, y: py }` not parsed"]
...
#[test]
#[ignore = "parser: record pattern with `..` rest not parsed"]
...
#[test]
#[ignore = "parser: qualified variant patterns `Option.Some(x)` not parsed"]
...
#[test]
#[ignore = "parser: tuple pattern with `..` rest not parsed"]
...
#[test]
#[ignore = "parser: duplicate-field detection in record type not implemented (deferred to typeck)"]
